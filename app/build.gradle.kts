...
android {
  ...
  signingConfigs {
    create("release") {
      val keystorePath = getEnvOrProperty("KEYSTORE_PATH", "${rootDir}/my-upload-key.jks")
      storeFile = file(keystorePath)
      storePassword = getEnvOrProperty("STORE_PASSWORD")
      keyAlias = getEnvOrProperty("KEY_ALIAS", "upload")
...
// Helper to retrieve environment variable or property from .env / .env.example
fun getEnvOrProperty(key: String, defaultValue: String = ""): String {
  ...
  if (envFile.exists()) {
    ...
    if (propVal != null && propVal.isNotEmpty()) return propVal
  }
